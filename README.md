...
12. **What remains human-led**: The final verifying before sending offers, fixing malformed csv.
13. **Future Improvements**: Making the workflow run periodically and Connecting to whatsapp, getting real data proper fronted with authentication.
